...
class VersionsCommand extends SubCommand {
     ...
     */
    private static final String JAVA_VERSION_NOTICE = "Minecraft 1.17 requires Java 16+!";
    ...
    public void onExecute(@Nonnull CommandSender sender, @Nonnull String[] args) {
        if (sender.hasPermission("slimefun.command.versions") || sender instanceof ConsoleCommandSender) {
            ...
            builder.append(Component.text("Server environment running Slimefun:\n", Style.style(NamedTextColor.GRAY)))
            ...
            builder.append(Component.text("\nEnglish translation by RaoMicory", Style.style(NamedTextColor.WHITE)))
                    .append(Component.text(
                            "\nPlease do not use screenshots of this build to report bugs on Discord/GitHub\nReport translation issues on the translation page instead\n",
                            Style.style(NamedTextColor.RED)));

            if (Slimefun.getConfigManager().isBypassEnvironmentCheck()) {
                builder.append(Component.text(
                        "\n\nEnvironment compatibility checks are disabled", Style.style(NamedTextColor.RED)));
            }

            if (Slimefun.getConfigManager().isBypassItemLengthCheck()) {
                builder.append(Component.text("\n\nItem length checks are disabled", Style.style(NamedTextColor.RED)));
            }
    ...
    private void addPluginVersions(@Nonnull net.kyori.adventure.text.TextComponent.Builder builder) {
        ...
        builder.append(Component.text("Installed addons: ", NamedTextColor.GRAY))
                ...
                if (plugin instanceof SlimefunAddon addon && addon.getBugTrackerURL() != null) {
                    ...
                    try {
                        ...
                        Component hoverComp = Component.text()
                                ...
                                .append(Component.text("\n> Click to open feedback page", NamedTextColor.GOLD))
                                .build();
                        ...
                        Component hoverComp = Component.text()
                                .append(Component.text("Author: ", NamedTextColor.YELLOW))
                                .append(Component.text(authors, NamedTextColor.YELLOW))
                                .append(Component.text("\n> The addon feedback link is invalid!", NamedTextColor.RED))
                                .build();
                    ...
                    try {
                        ...
                        Component hoverComp = Component.text()
                                .append(Component.text(
                                        "This plugin is disabled.\nCheck the console for errors.", NamedTextColor.RED))
                                .append(Component.text(
                                        "\n> The plugin feedback link is invalid", NamedTextColor.DARK_RED))
                                .build();
