...
public class ErrorReport<T extends Throwable> {
    ...
    public ErrorReport(T throwable, Location l, SlimefunItem item) {
        this(throwable, item.getAddon(), stream -> {
            stream.println("Block information:");
            ...
            stream.println("  Block type: " + l.getBlock().getType());
            stream.println(
            ...
            if (item.getBlockTicker() != null) {
                stream.println("Ticker information:");
                stream.println("  Type: " + (item.getBlockTicker().isSynchronized() ? "Synchronous" : "Asynchronous"));
                stream.println();
            }
            ...
            if (blockData == null) {
                        ...
                        .ifPresentOrElse(
                                uuid -> {
                                    ...
                                    if (universalData != null) {
                                        stream.println("  Data loaded: " + universalData.isDataLoaded());
                ...
                stream.println("  Data loaded: " + blockData.isDataLoaded());
