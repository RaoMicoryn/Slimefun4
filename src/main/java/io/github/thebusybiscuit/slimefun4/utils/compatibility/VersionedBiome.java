...
/**
 * Multi-version compatibility for Biome
 *
 * @author ybw0014
 */
public final class VersionedBiome {
    ...
    static {
        ...
        try {
            ...
            Slimefun.logger().severe("Failed to initialize multi-version Biome compatibility: " + e.getMessage());
        }
    ...
    public static Biome valueOf(@Nonnull String biomeName) throws IllegalArgumentException {
        ...
        try {
            ...
            throw new IllegalArgumentException("Failed to invoke Biome.valueOf: " + biomeName, e);
        }
