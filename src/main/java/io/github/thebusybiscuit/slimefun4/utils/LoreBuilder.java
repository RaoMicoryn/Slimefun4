...
public final class LoreBuilder {
    ...
    public static final String RAINBOW = "&dCycles through rainbow colors!";
    ...
    public static final String CROUCH_TO_USE = "&eSneak &eand Right Click&7 to use";
    ...
    public static @Nonnull String hunger(double value) {
        return "&7&oRestores &b&o" + hungerFormat.format(value) + " &7&o Hunger";
    }
