...
/**
 * Sound multi-version compatibility
 *
 * @author ybw0014
 */
public final class VersionedSound {
    ...
    static {
        ...
        try {
            ...
            Slimefun.logger().severe("Failed to determine Sound type: " + e.getMessage());
        }
    ...
    public static Sound valueOf(@Nonnull String name) throws IllegalArgumentException {
        ...
        try {
            ...
            throw new IllegalArgumentException("Failed to invoke Sound.valueOf: " + name, e);
        }
