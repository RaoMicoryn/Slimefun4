...
public abstract class AbstractEntityAssembler<T extends Entity> extends SimpleSlimefunItem<BlockTicker>
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        preset.addItem(
                1,
                new CustomItemStack(getHead(), "&7Insert Head", "", "&fPlace the item used as the entity head here"),
                ChestMenuUtils.getEmptyClickHandler());
        preset.addItem(
                7,
                new CustomItemStack(
                        getBody(), "&7Insert Body Material", "", "&fPlace the item used as the entity body here"),
                ChestMenuUtils.getEmptyClickHandler());
        preset.addItem(
                13,
                new CustomItemStack(
                        ...
                        "",
                        "&fThis machine needs 30 seconds to assemble",
                        "&fPlease be patient!"),
                ChestMenuUtils.getEmptyClickHandler());
    }
