    ...
    private void reportErrors(Location l, SlimefunItem item, Throwable x) {
        ...
        if (errors == 1) {
            ...
            Slimefun.logger()
                    .log(
                            Level.SEVERE,
                            "Multiple errors occurred during the last 4 ticks; the machine at this block has been disabled.");
            Slimefun.logger().log(Level.SEVERE, "See /plugins/Slimefun/error-reports/ for details.");
            Slimefun.logger()
                    .log(
                            Level.SEVERE,
                            "When asking for help, send the error report file instead of a screenshot of this message.");
