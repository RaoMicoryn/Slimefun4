...
public class ProgrammableAndroid extends SlimefunItem
        ...
        new UniversalMenuPreset(getId(), "Programmable Android") {
            ...
            public void newInstance(UniversalMenu menu, Block b) {
                ...
                menu.replaceExistingItem(
                        15, new CustomItemStack(HeadTexture.SCRIPT_START.getAsItemStack(), "&aStart/Resume"));
    ...
    public void openScript(Player p, SlimefunUniversalBlockData uniData, String sourceCode) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&7\u21E8 &eLeft Click &7to return to the Android control panel"));
    ...
    protected void openScriptDownloader(Player p, SlimefunUniversalBlockData uniData, int page) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "&eUpload Script",
                        "",
                        "&6Click &7to upload your current script",
                        "&7to the server"));
        ...
        menu.addItem(
                53,
                new CustomItemStack(
                        HeadTexture.SCRIPT_LEFT.getAsItemStack(), "&6> Back", "", "&7Return to Android control panel"));
    ...
    public void openScriptEditor(Player p, SlimefunUniversalBlockData uniData) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "&4> Create New Script",
                        "",
                        "&cDelete your current script",
                        "&cand create a new blank script"));
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "&6> Download Scripts",
                        "",
                        "&eDownload scripts uploaded by other players",
                        "&eUse them as-is or modify them before use"));
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        for (MachineFuel fuel : fuelTypes) {
            ...
            lore.add(ChatColors.color("&8\u21E8 &7Remaining: " + NumberUtils.getTimeLeft(fuel.getTicks() / 2)));
            im.setLore(lore);
            item.setItemMeta(im);
            list.add(item);
        }
