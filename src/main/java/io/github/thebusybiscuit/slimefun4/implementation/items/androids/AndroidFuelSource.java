...
public enum AndroidFuelSource {
     ...
     */
    SOLID("", "&fThis type of Android requires solid fuel", "&fFor example: coal, logs, and more..."),

    /**
     * This {@link ProgrammableAndroid} runs on liquid fuel, e.g. Fuel, Oil or Lava
     */
    LIQUID("", "&fThis type of Android requires liquid fuel", "&fFor example: lava, crude oil, fuel, and more..."),

    /**
     * This {@link ProgrammableAndroid} runs on nuclear fuel, e.g. Uranium
     */
    NUCLEAR("", "&fThis type of Android requires radioactive fuel", "&fFor example: Uranium, Neptunium, or MOX fuel");
