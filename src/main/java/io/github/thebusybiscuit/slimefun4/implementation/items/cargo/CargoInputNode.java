        ...
        if (roundRobinMode == null || roundRobinMode.equals(String.valueOf(false))) {
            menu.replaceExistingItem(
                    ...
                    new CustomItemStack(
                            ...
                            "&e(Items will be distributed evenly across the channel)"));
        ...
        if (smartFillNode == null || smartFillNode.equals(String.valueOf(false))) {
            menu.replaceExistingItem(
                    ...
                    new CustomItemStack(
                            ...
                            "&e> Click to enable",
                            "",
                            "&fThe cargo node will try to keep",
                            "&fitems in the cargo network at a set amount",
                            "&fwhen enabled, but this feature is not perfect",
                            "&fit will still try to fill empty slots before a stack"));
