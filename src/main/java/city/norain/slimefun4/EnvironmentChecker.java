...
class EnvironmentChecker {
    ...
    static boolean checkIncompatiblePlugins(@Nonnull Logger logger) {
        ...
        logger.log(Level.WARNING, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        logger.log(Level.WARNING, "Incompatible plugins detected; Slimefun has been disabled!");
        logger.log(Level.WARNING, "Incompatible plugins: ", String.join(", ", plugins));
        logger.log(Level.WARNING, "These plugins are listed because they are incompatible with the current");
        ...
        logger.log(Level.WARNING, "please contact us to update the compatibility list.");
        logger.log(Level.WARNING, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        logger.log(Level.WARNING, "");
        printBorder(logger);
                        ...
                        () -> {
                            if (Bukkit.getPluginManager().getPlugin("SlimeGlue") == null) {
                                sf.getLogger()
                                        .log(
                                                Level.WARNING,
                                                "SlimeGlue is not installed; extra protection checks for some plugins are unavailable!");
